use crate::for_impl::*;
use crate::function::{Function, FunctionDec, RelFun};
use crate::prelude::*;
...
//Functions
pub fn fun(head: FunctionDec, f: Box<dyn RelFun>) -> Function {
    Function::new(head, f)
}

pub fn fun_variadic(name: &str, kind: DataType) -> FunctionDec {
    FunctionDec::new_variadic(name, kind)
}
